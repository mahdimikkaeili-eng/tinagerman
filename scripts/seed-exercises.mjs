  ...
  modes: [
    {
      ...
      items: [
        ...
        { word: 'Tuer', answer: 'die', emoji: '\u{1F6AA}', hint: 'die Tuer - written with an umlaut: die Tur with two dots.' },
        { word: 'Schluessel', answer: 'der', emoji: '\u{1F511}', hint: 'Nouns ending in -el are often der.' },
        ...
        { word: 'Maedchen', answer: 'das', emoji: '\u{1F467}', hint: 'Every -chen word is das, even for a girl.' },
    ...
    },
    {
      ...
      questions: [
        {
          prompt: '___ Hund schlaeft im Garten.',
          speak: 'Der Hund schlaeft im Garten.',
          options: ['Der', 'Die', 'Das'],
          answer: 'Der',
  ...
  modes: [
    {
      ...
      questions: [
        ...
        {
          prompt: 'Sie lernt Deutsch, ___ sie in Wien arbeiten moechte.',
          speak: 'Sie lernt Deutsch, weil sie in Wien arbeiten moechte.',
          options: ['weil', 'dass', 'wenn'],
          answer: 'weil',
    ...
    },
    {
      ...
      questions: [
        {
          prompt: 'Ich komme spaeter, weil ...',
          speak: 'Ich komme spaeter, weil ich noch arbeiten muss.',
        ...
        {
          prompt: 'Wenn das Wetter schoen ist, ...',
          speak: 'Wenn das Wetter schoen ist, gehen wir spazieren.',
        ...
        {
          prompt: 'Ich weiss nicht, ob ...',
          speak: 'Ich weiss nicht, ob sie morgen Zeit hat.',
